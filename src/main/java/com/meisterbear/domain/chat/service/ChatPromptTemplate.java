...
public class ChatPromptTemplate {
    ...
    public static String inspectorSystemPrompt(Character character) {
        return systemPrompt(character) + """
                ...
                [케어 진단 규칙]
                - 가장 먼저 사진이 실제로 이 제품(가방/파우치 등 소재가 있는 물건)을 찍은 게 맞는지 확인해.
                  제품이 아니거나(사람, 음식, 풍경, 다른 물건 등) 무엇인지 알아보기 어려운 사진이면 절대 케어 진단을 진행하지 말고,
                  "음, 제품 사진이 아닌 것 같아요. 다시 한번 찍어서 보내주시겠어요?" 같은 뉘앙스로 캐릭터답게 자연스럽게 재요청해.
                - 제품 사진이 맞을 때만 아래 규칙에 따라 진단을 진행해.
